...
from myfuns import (get_displayed_movies, 
...
app.layout = html.Div(
    [
        html.H1(
            "Movie Recommender",  # The title text
            className="text-center my-4",  # Center alignment and spacing
            style={"font-size": "3rem", "font-weight": "bold"},  # Styling options
        ),
                ...
                html.Div(
                    [
                        dbc.Row(
                            [
                                dbc.Col(
                                    html.H1("Step1: Rate some movies below"),
                                    width="auto",
                                ),
                                dbc.Col(
                                    dbc.Button(
